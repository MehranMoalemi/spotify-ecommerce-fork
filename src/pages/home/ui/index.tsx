...
export const Home = () => {
  return (
    <main className="flex min-h-screen max-w-[80rem] mx-auto flex-col items-center justify-between lg:px-24  ">
      <section className='flex mb-36 flex-col md:flex-row'>
        <MobileLightSpot  className='absolute w-[20rem] right-1/2 translate-x-[50%] top-[14%] md:hidden'/>
        <Dogs className='w-[20rem] mx-auto md:w-[25rem] relative  top-20 order-2 md:order-1'/> 
      <div className="relative  mr-auto flex px-4 w-full md:w-1/2  flex-col items-end justify-center gap-10 order-1 md:order-2">
        <div className="relative  flex h-40 md:h-60 w-full md:w-[25rem] flex-col items-center justify-center gap-4 rounded-[15px] bg-spotify-main text-center text-white before:absolute md:before:right-[-20px] before:right-[0] before:top-1/2 before:h-0 before:w-0 before:-translate-y-1/2 before:transform md:before:border-b-[10px] md:before:border-l-[20px] md:before:border-t-[10px] before:border-b-transparent before:border-l-spotify-main before:border-t-transparent md:before:content-['']">
          <p className="text-2xl md:text-3xl text-spotify-darker">
            مرجع تخصصی<br />
            خرید اکانت های پرمیوم
          </p>
          <span className="text-3xl md:text-[4rem] font-extrabold text-black">
            <strong>
              اسپاتیفای
            </strong>
          </span>
